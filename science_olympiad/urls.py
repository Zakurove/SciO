...
urlpatterns = [
    ...
    path(r'^inventors/register/$', views.add_inventor2, name='add_inventor'),
    

    # url(r'^contest/(?P<contest_id>\d+)/begin/$', views.begin_contest, name='begin_contest'),
    #
    path(r'^contest/end/$', views.show_contest_endpage, name='end_contest'),
    path(r'^contest/(?P<contest_id>\d+)/walkthrough/$', views.walkthrough_contest, name='handle_walkthrough'),
    path(r'^contest/walkthrough/1/$', views.walkthrough_contest1, name='walkthrough_contest1'),
    path(r'^contest/test_wheel/$', views.test_wheel, name='test_wheel'),
    ...
    path(r'^timer/$', views.timer, name='timer'),
